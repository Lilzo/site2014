<div class="divCenter">  
    <div><span class="tacke">::.</span><h1>Sektor gradnja i elektro-mašinska<br> proizvodnja</h1></div>
    <div id="tab-container" class="nadtabcontents">
        ...
        <div class="tabcontents"> 
            <?php
            //UPITI
            $ponuda = "SELECT * FROM clanci WHERE tab = 'ponuda' AND sektor = 'gradnja_el_mašinstvo' ORDER BY pozicija ASC";
            $o_sektoru = "SELECT * FROM clanci WHERE tab = 'o_sektoru' AND sektor = 'gradnja_el_mašinstvo' ORDER BY pozicija ASC";
            $download = "SELECT * FROM clanci WHERE tab = 'download' AND sektor = 'gradnja_el_mašinstvo' ";
            $reference = "SELECT * FROM clanci WHERE tab = 'reference' AND sektor = 'gradnja_el_mašinstvo' ";
            $kontakt = "SELECT * FROM clanci WHERE tab = 'kontakt' AND sektor = 'gradnja_el_mašinstvo' ORDER BY pozicija ASC";
			...
			<a href="#rj-gradnja">gradnja</a> | 
			<a href="#rj-masinstvo"> mašinstvo</a> | 
			<a href="#rj-elektro-odrzavanje"> elektro-održavanje </a>			
		</div>
		<br>
                <?php
