<div class="divCenter">  
    <div id="h1-single-line">
        ...
        <h1>Sektor Ugostiteljstvo i turizam</h1>
    </div>
    <div id="tab-container" class="nadtabcontents">
        ...
        <div class="tabcontents"> 
            <?php
            //UPITI
            $ponuda = "SELECT * FROM clanci WHERE tab = 'ponuda' AND sektor = 'ugostiteljstvo' ORDER BY pozicija ASC ";
            $o_sektoru = "SELECT * FROM clanci WHERE tab = 'o_sektoru' AND sektor = 'ugostiteljstvo' ORDER BY pozicija ASC";
            $download = "SELECT * FROM clanci WHERE tab = 'download' AND sektor = 'ugostiteljstvo' ";
            $reference = "SELECT * FROM clanci WHERE tab = 'reference' AND sektor = 'ugostiteljstvo' ";
            $kontakt = "SELECT * FROM clanci WHERE tab = 'kontakt' AND sektor = 'ugostiteljstvo' ORDER BY pozicija ASC";
            ...
            <div id="o_sektoru" class="tabcontent">
              <div class="simpleLink">
                <a href="#rj-ugostiteljtvo">ugostiteljstvo</a> | 
                <a href="#rj-dom-rudara">dom rudara</a> |
				<a href="#program-proizvodnje-i-odgoja-ribe">odgoj ribe</a> |
                <a href="#rj-boksit-turs">boksit turs</a>
            </div>
            <br>
                <?php
