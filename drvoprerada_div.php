<div class="divCenter">  
    ...
    <div id="tab-container" class="nadtabcontents">
        ...
        <div class="tabcontents"> 
            <?php
            //UPITI
            $ponuda = "SELECT * FROM clanci WHERE tab = 'ponuda' AND sektor = 'drvoprerada' ORDER BY pozicija ASC ";
            $o_sektoru = "SELECT * FROM clanci WHERE tab = 'o_sektoru' AND sektor = 'drvoprerada' ORDER BY pozicija ASC";
            $download = "SELECT * FROM clanci WHERE tab = 'download' AND sektor = 'drvoprerada' ";
            $reference = "SELECT * FROM clanci WHERE tab = 'reference' AND sektor = 'drvoprerada' ";
            $kontakt = "SELECT * FROM clanci WHERE tab = 'kontakt' AND sektor = 'drvoprerada' ORDER BY pozicija ASC";
            ...
            <div class="simpleLink">
                <a href="#primarna-prerada"> primarna prerada</a> | 
                <a href="#parenje-i-susenje">parenje i sušenje</a> |
                <a href="#decimirnica"> decimirnica</a> |
                <a href="#masivne-ploce"> lijepljene masivne ploče</a> |
                <a href="#namjestaj"> masivni namještaj</a> |
