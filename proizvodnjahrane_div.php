<div class="divCenter">  
    <div id="h1-single-line">
        ...
        <h1>Sektor proizvodnja hrane</h1>
    </div>
    <div id="tab-container" class="nadtabcontents">
        ...
        <div class="tabcontents"> 
            <?php
            //UPITI
            $ponuda = "SELECT * FROM clanci WHERE tab = 'ponuda' AND sektor = 'proizvodnja_hrane' ORDER BY pozicija ASC ";
            $o_sektoru = "SELECT * FROM clanci WHERE tab = 'o_sektoru' AND sektor = 'proizvodnja_hrane' ORDER BY pozicija ASC";
            $download = "SELECT * FROM clanci WHERE tab = 'download' AND sektor = 'proizvodnja_hrane' ";
            $reference = "SELECT * FROM clanci WHERE tab = 'reference' AND sektor = 'proizvodnja_hrane' ";
            $kontakt = "SELECT * FROM clanci WHERE tab = 'kontakt' AND sektor = 'proizvodnja_hrane' ORDER BY pozicija ASC";
            ...
            <div id="o_sektoru" class="tabcontent">
              <div class="simpleLink">
                <a href="#farma-koka-nosilja">farma koka nosilja</a> 
            </div>
            <br>
                <?php
