...
var Lightbox = {	
	...
	updateDetails: function() {
		...
		new Effect.Parallel(
		// dvije linije ispod omoguæavaju efekt na prostor iznad slike sa kontrolama slide show-a
			[// new Effect.SlideDown( this.getID('imageDataContainer'), { sync: true }), 
			  new Effect.Appear(this.getID('imageDataContainer'), { sync: true }) ], 
			{ duration:0, afterFinish: function() { Lightbox.updateNav();} } //duration: .65  
		);
	},
	...
	keyboardAction: function(e) {
		...
		if(key == 'x' || key == 'o' || key == 'c' || e.keyCode == 27){ // close lightbox
			Lightbox.end();
