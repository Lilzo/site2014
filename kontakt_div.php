                ...
                <form method="post" name="formPodaci" action="" onsubmit="return validateFormImePrezime()">
                    <ul>
                        ...
                        <li><div class="btnOrder" id="btn-order-text">Komentar</div>
                            <textarea id="textarea-komentar"  name="poruka" cols="38" rows="20"
                    ...
                    if (isset($_POST['ime']) && isset($_POST['email']) && isset($_POST['poruka'])) {
                        ...
                        $poruka = nl2br($_POST['poruka']);

                        // set here
                        $subject = "Poruka sa sajta preko kontakt forme od " . $ime;
                        $to = 'boksit@ad-boksit.com';

                        $msg = "<html><body style='font-family:Arial,sans-serif;'>";
                        $msg .= "<p><strong>Poslao:</strong> " . $ime . "</p>\r\n";
                        $msg .= "<p><strong>Mail:</strong> " . $email . "</p>\r\n";
                        $msg .= "<p><strong>Poruka: </strong> <br> <br>" . $poruka . "</p>\r\n";
                        $msg .= "</body></html>";

                        $headers = "From: $email\r\n";
                        $headers .= 'Cc: ozren.srdic@ad-boksit.com' . "\r\n";
