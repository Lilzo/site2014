<div class="divCenter">  
     <div><span class="tacke">::.</span><h1>Sektor komercijalno-proizvodni<br> poslovi</h1></div>
    <div id="tab-container" class="nadtabcontents">
        ...
        <div class="tabcontents"> 
            <?php
            //UPITI
            $ponuda = "SELECT * FROM clanci WHERE tab = 'ponuda' AND sektor = 'komercijalni_poslovi' ORDER BY pozicija ASC ";
            $o_sektoru = "SELECT * FROM clanci WHERE tab = 'o_sektoru' AND sektor = 'komercijalni_poslovi' ORDER BY pozicija ASC";
            $download = "SELECT * FROM clanci WHERE tab = 'download' AND sektor = 'komercijalni_poslovi' ";
            $reference = "SELECT * FROM clanci WHERE tab = 'reference' AND sektor = 'komercijalni_poslovi' ";
            $kontakt = "SELECT * FROM clanci WHERE tab = 'kontakt' AND sektor = 'komercijalni_poslovi' ORDER BY pozicija ASC";
			...
			<a href="#kineski-program"> kineski program</a>| 
			<a href="#program-komercijalno-tehnicki-poslovi"> komercijalno-tehnički poslovi</a>|
			<a href="#program-roba-siroke-potrosnje"> kupoprodaja robe i usluga</a> |
			<a href="#papirna-ambalaza"> papirna ambalaža</a> |
			<a href="#program-goriva"> goriva i ulja</a> |
			<a href="#program-rezervni-dijelovi">rezervni dijelovi i gume</a>
                </div>
                <br>
                <?php
